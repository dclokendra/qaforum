                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($data['questions'] as $question)
                                    <tr>
                                        ...
                                        <td><a href="{{route('question.edit',$question->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i>edit</a>
                                            <form action="{{route('question.destroy',$question->id)}}" method="post" onsubmit="return confirm('Are you surer to Delete')">
                                                @csrf
