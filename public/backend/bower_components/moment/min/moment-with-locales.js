;(function (global, factory) {
    ...
    // instance.  Otherwise, it will return the locale profile
    ...
    var lang = deprecate(
        'moment().lang() is deprecated. Instead, use moment().localeData() to get the language profile. Use moment().locale() to change languages.',
        function (key) {
            if (key === undefined) {
